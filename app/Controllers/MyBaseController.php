...
abstract class MyBaseController extends BaseController
{
    ...
    public function run_view()
    {
        ...
        $this->data['bildirim_dogumcount'] = true;
        $this->data['bildirim_onaycount'] = true;
        ...
        $this->data["bildirim_dogumcount"] = $this->personelModel->bildirim_dogumcount(array());
        $this->data["bildirim_onaycount"] = $this->izinModel->bildirim_onaycount(array());
