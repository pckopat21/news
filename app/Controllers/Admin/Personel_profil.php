...
class Personel_profil extends MyBaseController
{
    ...
    {
        $data = [];
        $data["title"] = "Personel Detayı";
        $data["subtitle"] = "Personel Detay Listeleme";
        $data["main"] = "admin";
    ...
    {
        $data = [];
        $data["title"] = "Personel Profili";
        $data["subtitle"] = "Personel Profil Bilgileri";
        $data["main"] = "admin";
        $data["mf"] = "personel_profil";
        $data["sf"] = "list";
        $data["personel_profil"] = $this->personelModel->personel_profil(array("personel_id"=>$personel_id));
        $data["personel_profilizin"] = $this->izinkullanimModel->personel_profilizin(array("personel_id"=>$personel_id));
        $data["durum"] = $this->durumModel->c_all(); // Şimdi veri çekme sırasında
        $data["gorev"] = $this->gorevModel->c_all(); // Şimdi veri çekme sırasında
        $data["unvan"] = $this->unvanModel->c_all(); // Şimdi veri çekme sırasında
        $data["gorev_yeri"] = $this->gorevyeriModel->c_all(); // Şimdi veri çekme sırasında
