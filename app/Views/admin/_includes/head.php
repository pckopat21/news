...
<!-- Toastr -->
<link rel="stylesheet" href="<?= base_url()?>/admin/assets/plugins/toastr/toastr.min.css">
<!-- sweatalert2 -->
<link rel="stylesheet" href="<?= base_url()?>/admin/assets/plugins/sweetalert2/sweetalert2.min.css">
<!-- Switchery -->
<link rel="stylesheet" href="<?= base_url()?>/admin/assets/plugins/switchery/dist/switchery.min.css"></script>
<!-- Theme style -->
<link rel="stylesheet" href="<?= base_url()?>/admin/assets/dist/css/adminlte.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="<?= base_url()?>/admin/assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?= base_url()?>/admin/assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
