...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"><span class="dropdown-item dropdown-header">Onay Bekleyen İşlemler</span>
        <div class="dropdown-divider"></div>
        <a href="<?= base_url("admin/bildirim/bildirim_onay")?>" class="dropdown-item"><i class="fas fa-users mr-2"></i><?php if ($bildirim_onaycount->izin_onay > 0) echo $bildirim_onaycount->izin_onay;?> Personel Onay Bekliyor<span class="float-right text-muted text-sm">us</span></a>
        <div class="dropdown-divider"></div>
