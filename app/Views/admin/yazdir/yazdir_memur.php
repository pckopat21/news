...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 102. maddesine göre <?php echo date("d.m.Y",strtotime($izincek['izin_baslayis'])) ?> tarihinden geçerli olmak üzere <?php echo $izincek['izin_yil'] ?> yılına <br>&emsp;mahsuben <?php echo $izincek['izin_suresi'] ?> (<?php echo yaziylasayi($izincek['izin_suresi']) ?>) günlük senelik izin verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
