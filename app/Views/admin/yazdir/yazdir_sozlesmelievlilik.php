...
$izinsor=$db->prepare("SELECT p.personel_adres,i.izin_vefat,d.durum_ad,u.unvan_ad,p.personel_adsoyad,p.personel_tc,p.personel_sicilno,it.izin_ad,i.izin_tarih,
...
<table border="0" cellpadding="0" cellspacing="0" width="1060" height="43">
    <tr>
        <td width="1060" height="43">
            <p align="center"><b><font face="Times New Roman"><span style="font-size:16pt;">SÖZLEŞMELİ MEMUR İZİN FORMU</span></font></b><font size="4"></font></p>
        </td>
    </tr>
</table>
...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre <?php echo date("d.m.Y",strtotime($izincek['izin_baslayis'])) ?> tarihinden geçerli olmak üzere <br>&emsp;  <?php echo $izincek['izin_suresi'] ?> (<?php echo yaziylasayi($izincek['izin_suresi']) ?>) günlük <?php echo $izincek['izin_ad'] ?> verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
