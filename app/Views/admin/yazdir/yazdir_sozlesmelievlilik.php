...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre <?php echo date("d.m.Y",strtotime($izin_yazdir->izin_baslayis)) ?> tarihinden geçerli olmak üzere <br>&emsp;  <?=$izin_yazdir->izin_suresi ?> (<?php echo yaziylasayi($izin_yazdir->izin_suresi) ?>) günlük <?=$izin_yazdir->izin_ad ?> verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
