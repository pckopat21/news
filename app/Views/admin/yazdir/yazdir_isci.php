...
</span></font></b><!--<font size="4">fgdfgd</font>--></p>
        </td>
    </tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
...
&emsp;&emsp;&emsp;Toplu İş Sözleşmesinin 60. Maddesine göre <?= $izin_yazdir->izin_suresi ?> (<?php echo yaziylasayi($izin_yazdir->izin_suresi) ?>) gün <?= $izin_yazdir->izin_yil ?> yılı iznimin <?php echo date("d.m.Y",strtotime($izin_yazdir->izin_baslayis)) ?> tarihinden geçerli olmak üzere  <br>&emsp;&emsp;verilmesini müsadelerinize arz ederim.</span>
<span style="font-size:14pt;"><br>&nbsp;</span></font></p>
                    </td>
                </tr>
                <tr>
                    <td width="920" height="33" colspan="2">&nbsp;</td>
                    <td width="140" height="33"><font face="Times New Roman" style="font-size:14pt;"><?php echo date('d.m.Y'); ?></font></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="925" height="12" colspan="2"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?php echo date("d.m.Y",strtotime($izin_yazdir->personel_isegiristarih)) ?></span></td>
                </tr>                <tr>
...
KARAYOLLARI 5. BÖLGE MÜDÜRLÜĞÜNE</b></span></font></p>
                ...
                <tr>
                    <td width="1060" height="61" colspan="3">
                        <p align="left"><font style="font-size:14pt;" face="Times New Roman">
<br>

&emsp;&emsp;&emsp;İlgilinin belirtilen tarihler arasinda <?= $izin_yazdir->izin_suresi ?> (<?php echo yaziylasayi($izin_yazdir->izin_suresi) ?>) gün <?= $izin_yazdir->izin_yil ?>  yılı iznini kullanmasında sakınca olmadığını arz ederim.</font></p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="1060" height="100" colspan="3">
                        <p align="center"><b><font face="Times New Roman"><span style="font-size:14pt;">UYGUNDUR<br><br>
                                            ...../...../<?php echo date("Y"); ?><br>
                                            <br>
                                            &nbsp;</span></font></b></p>
                    </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="1061" height="423">
                ...
                <tr>
                    <td width="1061" height="29" colspan="5">
                        <p align="left"><font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Adı geçen personel yukarıda belirtilen iznini ...../...../<?php echo date("Y"); ?>  -  ....../....../<?php echo date("Y"); ?> tarihleri arasında (......) gün kullanmıştır</font></p>
                    </td>
                </tr>
                <tr>
                    <td width="1061" height="10" colspan="5"><font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Gereğini bilgilerinize arz ederim.</font></td>
                </tr>
                <tr>
