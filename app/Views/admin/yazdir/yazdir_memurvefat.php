...
$izinsor=$db->prepare("SELECT i.izin_vefat,d.durum_ad,u.unvan_ad,p.personel_adsoyad,p.personel_tc,p.personel_sicilno,it.izin_ad,i.izin_tarih,
...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre <?php echo date("d.m.Y",strtotime($izincek['izin_baslayis'])) ?> tarihinden geçerli olmak üzere <br>&emsp;<?php echo $izincek['izin_vefat'] ?> vefatından dolayı <?php echo $izincek['izin_suresi'] ?> (<?php echo yaziylasayi($izincek['izin_suresi']) ?>) günlük vefat izni verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="925" height="11" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?php echo $izincek['izin_adresi']; ?></span></td>
                </tr>
                <tr>
